						...
						<div className="relative z-10">
							...
							<div className="space-y-4 mb-6">
								<h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 leading-tight">
									<span className="block font-caveat font-bold text-slate-700 mb-6">Shipping is key to</span>
							...
							<p className="text-lg md:text-xl text-slate-600 max-w-2xl mb-10 leading-relaxed">
								Increase conversions up to 50% at checkout with customized rates, pickup and
								delivery options, transparent delivery times and more!
							</p>
